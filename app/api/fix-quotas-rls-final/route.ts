...
DROP POLICY IF EXISTS "Users can view quotas" ON company_minutes_quotas;
DROP POLICY IF EXISTS "Allow quota updates" ON company_minutes_quotas;
DROP POLICY IF EXISTS "Allow quota deletion" ON company_minutes_quotas;
...
SELECT 'RLS policies for company_minutes_quotas updated successfully!' as result;
  ...
  return NextResponse.json({
    message: 'Please run this SQL script in your Supabase Dashboard > SQL Editor to fix the RLS policies',
    sqlScript,
    instructions: [
      '1. Go to your Supabase Dashboard',
      '2. Navigate to SQL Editor',
      '3. Paste the SQL script provided',
