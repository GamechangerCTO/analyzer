        ...
        <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
          <section>
            ...
            <p>
              ...
              השימוש בפלטפורמה מחייב הסכמה נוספת להקלטת, עיבוד וניתוח שיחות באמצעות טכנולוגיות ניתוח מתקדמות.
          ...
          <section>
            <h2 className="text-2xl font-semibold text-gray-800 mb-4">הקלטות ועיבוד אוטומטי</h2>
            <p>שימוש בשירותי העיבוד האוטומטי שלנו כפוף לתנאים הבאים:</p>
            <ul className="list-disc list-inside space-y-2 mt-4">
              ...
              <li><strong>שפות נתמכות:</strong> השירות מותאם בעיקר לעברית ואנגלית</li>
                              <li><strong>דיוק הניתוח:</strong> הניתוח האוטומטי מספק תוצאות הטובות ביותר הזמינות, אך אינו מובטח להיות מושלם</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mt-4">
              <li><strong>דיוק הניתוח:</strong> אנו לא מתחייבים לדיוק מוחלט של הניתוח האוטומטי או התמלולים</li>
